...
fun SepatuDialog(
    ...
    var jenisSepatu by remember { mutableStateOf("") }
    ...
    Dialog(onDismissRequest = { onDismissRequest() }) {
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    value = jenisSepatu,
                    onValueChange = { jenisSepatu = it },
                    label = { Text(text = stringResource(id = R.string.jenis_sepatu)) },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                ...
                Row(
                    ...
                    OutlinedButton(
                        onClick = { onConfirmation(merk, jenisSepatu) },
                        enabled = merk.isNotEmpty() && jenisSepatu.isNotEmpty(),
                        modifier = Modifier.padding(8.dp)
                    ) {
